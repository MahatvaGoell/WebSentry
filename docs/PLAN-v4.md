# WebSentry v4 — Attack Surface: API, Subdomains, Misconfiguration
...
> "What WebSentry does *not* do" section; `CLAUDE.md` gained the plan's two
...
WebSentry' URL scan today looks at exactly one host, over HTTP and DNS, through
...
- **README** — the agent table goes from five rows to eight; a new
  "What WebSentry does *not* do" section stating plainly, per agent, what is out
