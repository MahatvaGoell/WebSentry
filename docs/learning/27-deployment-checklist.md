...
WebSentry is passive-only — it can only read, never probe. That limits what it can actually confirm:

| Tier | What it means | Example |
|---|---|---|
| **auto** | WebSentry saw this directly | HSTS header was missing |
...
- **Self-attested** — a check WebSentry cannot run passively; the developer answers it manually.
