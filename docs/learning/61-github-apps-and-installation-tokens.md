...
The permission half of Stage B: the machinery that lets WebSentry prove it
...
3. That JWT proves *"I am the WebSentry App."* It still cannot touch a single
...
Someone can do the first and never the second — and WebSentry has to work
