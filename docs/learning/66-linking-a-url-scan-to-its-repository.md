...
> deterministic fix — once you tell WebSentry which repository serves the site.
...
installed the WebSentry App on, type a repo name, click "Link repository."
WebSentry then reads that repo, figures out whether it's a Vercel or Next.js
