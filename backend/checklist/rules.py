...
into three tiers (see PLAN-v2.md §0.1):
  ...
  auto         — WebSentry observed this directly (from an agent finding)
...
RULES: list[ChecklistRule] = [
    ...
    ChecklistRule(
        ...
        evaluate=lambda _: (
            "unknown",
            "WebSentry cannot test this passively. Confirm that all user inputs "
    ...
    ChecklistRule(
        ...
        evaluate=lambda _: (
            "unknown",
            "WebSentry cannot test this passively. Confirm that rate limits are "
    ...
    ChecklistRule(
        ...
        evaluate=lambda _: (
            "unknown",
            "WebSentry cannot test this passively. Confirm that authentication "
    ...
    ChecklistRule(
        ...
        evaluate=lambda _: (
            "unknown",
            "WebSentry cannot test this passively. Confirm that production "
