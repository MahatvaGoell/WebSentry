...
REPO_RULES: list[ChecklistRule] = [
    ...
    ChecklistRule(
        ...
        evaluate=lambda _: (
            "unknown",
            "WebSentry cannot test this passively. If the Secrets agent ever "
    ...
    ChecklistRule(
        ...
        evaluate=lambda _: (
            "unknown",
            "WebSentry cannot test this passively -- branch protection is a "
    ...
    ChecklistRule(
        ...
        evaluate=lambda _: (
            "unknown",
            "WebSentry cannot test this passively. Confirm 2FA is required "
    ...
    ChecklistRule(
        ...
        evaluate=lambda _: (
            "unknown",
            "WebSentry cannot test this passively. Confirm at least one "
