...
WebSentry has no password anywhere: GitHub already knows who this person is,
...
Step 5 is a deliberate choice. WebSentry needs to know *who you are*, which
...
def get_frontend_origin() -> str:
    ...
    """
    return os.environ.get("WEBSENTRY_FRONTEND_ORIGIN") or "http://localhost:3000"
...
def install_url(state: str) -> str:
    """Where to send a user who wants to grant WebSentry write access.
...
class GitHubIdentity:
    """The only three things WebSentry keeps from a sign-in."""
