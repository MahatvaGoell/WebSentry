...
`websentry.db` therefore contains nothing anyone can present as a valid
...
def get_session_secret() -> str | None:
    ...
    """
    return os.environ.get("WEBSENTRY_SESSION_SECRET") or None
