...
that doesn't need one. This also keeps WebSentry at zero new third-party
...
DB_PATH = Path(__file__).parent / "data" / "websentry.db"
...
# PLAN-v5 Stage 0: identity. WebSentry had no notion of "who" until now — fine
