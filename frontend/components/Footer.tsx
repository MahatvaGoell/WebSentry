...
/* The scan page's closing section — structurally lifted from
   ...
   content swapped for WebSentry' own.
...
const PANELS: Record<string, Panel> = {
  ...
  checklist: {
    label: "Checklist",
    lead: "A deployment-readiness review, sorted by how much WebSentry can actually prove.",
    sections: [
      {
        heading: "Three tiers",
        items: [
          ...
          "Self-attested — things no passive scan can test. You answer these yourself, and WebSentry records the answer without ever checking it.",
        ],
      },
      {
  ...
  about: {
    label: "About",
    lead: "WebSentry is a passive security auditor. A URL or a repository goes in, five agents scan it concurrently, and a graded report comes out in under a minute.",
    sections: [
      {
      ...
      <footer className="mt-32 border-t border-rule bg-ink">
        <div className="mx-auto w-full max-w-7xl px-6 pt-16 pb-10 sm:px-8 lg:pt-24">
          ...
          <p className="mt-16 font-mono text-[10px] uppercase tracking-[0.2em] text-muted lg:mt-24">
            WebSentry — passive website security inspection
          </p>
        </div>
      </footer>
