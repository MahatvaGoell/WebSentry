...
import { GitHubAccount } from "@/components/landing/GitHubAccount";
    ...
    <SmoothScroll>
      ...
      <main className="flex flex-1 flex-col">
          ...
          header={
            <>
              ...
              <div className="h-[6.16vw] sm:h-[3.74vw] lg:h-[2.29vw]">
                ...
                >
                  <SplitText text="WebSentry" delay={150} stagger={0} />
                </h1>
              </div>
        ...
        {/* THE PAYOFF. The hero above is 560vh of pinned scrolling; this is
            ...
            WebSentry does, and burying it in a dropdown above a single input
