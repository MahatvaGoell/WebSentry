...
/* /settings — the page that was missing.
   ...
   grants WebSentry holds, and gives you a way to add or drop one. Both of the
    ...
    <main className="mx-auto w-full max-w-3xl px-6 py-20 sm:px-8">
      ...
      <section className="mt-14">
        ...
        <p className="mt-5 max-w-2xl text-sm leading-relaxed text-muted sm:text-base">
          Connecting an account lets WebSentry open pull requests on it. It can create a
          branch named <span className="font-mono text-xs text-parchment">websentry/…</span>{" "}
        ...
        {/* Said plainly, because "Disconnect" above cannot possibly mean more
            than this: WebSentry stops using the grant, GitHub still lists the
            App as installed until the user removes it there. */}
        <p className="mt-10 max-w-2xl font-mono text-[9px] leading-relaxed text-rule">
          Disconnecting stops WebSentry using an installation immediately. It does not
